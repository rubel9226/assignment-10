      ...
      <div className="container mx-auto h-16 px-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <Link href='/' className="text-xl md:text-2xl font-bold text-indigo-300">
            Digital Life Lessons admin
          </Link>
        </div>

        <nav className="hidden lg:flex gap-6">
          <Link href="/admin" className={` ${pathname === '/admin' ? "text-indigo-400 border-b-2 border-indigo-400" : "hover:text-indigo-300" }`}>Home</Link>
          <Link href="/admin/manage-users"  className={` ${pathname === '/admin/manage-users' ? "text-indigo-400 border-b-2 border-indigo-400" : "hover:text-indigo-300" }`}>Manage Users</Link>
          <Link href="/admin/manage-lessons"  className={` ${pathname === '/admin/manage-lessons' ? "text-indigo-400 border-b-2 border-indigo-400" : "hover:text-indigo-300" }`}>Manage Lessons</Link>
          <Link href="/admin/reported-lessons"  className={` ${pathname === '/admin/reported-lessons' ? "text-indigo-400 border-b-2 border-indigo-400" : "hover:text-indigo-300" }`}>Reported Lessons</Link>
